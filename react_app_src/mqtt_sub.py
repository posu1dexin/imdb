...
from imdb import scrape_imdb_data


MQTT_Topic = "imdb/testing" # Mqtt topic for scraping request
MQTT_Response_Topic = "imdb/response" #Mqtt topic for scrapped data 
